        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOnEnrollment = table.Column<bool>(type: "bit", nullable: false),
                    EmailOnAnnouncement = table.Column<bool>(type: "bit", nullable: false),
                    EmailOnClassStatus = table.Column<bool>(type: "bit", nullable: false),
                    EmailOnApplicationStatus = table.Column<bool>(type: "bit", nullable: false),
                    EmailOnPasswordChange = table.Column<bool>(type: "bit", nullable: false),
                    InAppOnEnrollment = table.Column<bool>(type: "bit", nullable: false),
                    InAppOnAnnouncement = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreEnrollments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreEnrollments_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PreEnrollments_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QaQuestions_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wishlists_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PreEnrollmentId = table.Column<int>(type: "int", nullable: false),
                    GatewayId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    SessionRef = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_PreEnrollments_PreEnrollmentId",
                        column: x => x.PreEnrollmentId,
                        principalTable: "PreEnrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_PreEnrollmentId",
                table: "PaymentTransactions",
                column: "PreEnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PreEnrollments_ClassId",
                table: "PreEnrollments",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_PreEnrollments_StudentId",
                table: "PreEnrollments",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_StudentId_ClassId",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_ClassId",
                table: "Wishlists",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_StudentId_ClassId",
                table: "Wishlists",
                columns: new[] { "StudentId", "ClassId" },
                unique: true,
                filter: "[StudentId] IS NOT NULL");
